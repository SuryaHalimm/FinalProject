<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @role('admin')
                        ...
                        <x-nav-link :href="route('kota.view')" :active="request()->routeIs('kota.view')">
                            {{ __('Kota') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.upload.form')" :active="request()->routeIs('admin.upload.form')">
                            {{ __('Upload') }}
                        </x-nav-link>
                    @else
                        {{-- <x-nav-link :href="route('kota.view')" :active="request()->routeIs('kota.view')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('kota.view')" :active="request()->routeIs('kota.view')">
                {{ __('Kota') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.upload.form')" :active="request()->routeIs('admin.upload.form')">
                {{ __('Upload') }}
            </x-responsive-nav-link>
        </div>
